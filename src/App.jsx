...
import iconUbuntu from './assets/Ubuntu Icon.png';
import iconYouthLed from './assets/Youth-Led Icon.png';
import iconScalable from './assets/Scalable Icon.png';
      ...
      `}} />
            ...
            <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'glass-panel shadow-sm py-2' : 'bg-transparent py-4'}`}>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        ...
                        <div className="hidden md:flex items-center space-x-8">
                            <a href="#features" className="text-sm font-semibold text-slate-600 hover:text-panhari-red transition-colors">Features</a>
                            <a href="#how-it-works" className="text-sm font-semibold text-slate-600 hover:text-panhari-red transition-colors">How it works</a>
                            <a href="#stories" className="text-sm font-semibold text-slate-600 hover:text-panhari-red transition-colors">Stories</a>
                            <button className="bg-panhari-dark hover:bg-panhari-red text-white px-6 py-2.5 rounded-full text-sm font-semibold transition-all duration-300 transform hover:scale-105 hover:-translate-y-0.5 shadow-md shadow-slate-200 hover:shadow-panhari-red/20">
                                Book a Demo
                            </button>
                        </div>
                ...
                <div className={`md:hidden absolute w-full glass-panel border-b border-white/50 px-4 pt-2 pb-6 space-y-2 shadow-xl transition-all duration-300 origin-top ${isMenuOpen ? 'opacity-100 scale-y-100' : 'opacity-0 scale-y-0 pointer-events-none'}`}>
                    <a href="#features" onClick={() => setIsMenuOpen(false)} className="block px-4 py-3 text-base font-semibold text-slate-700 hover:bg-panhari-red/5 hover:text-panhari-red rounded-xl transition-colors">Features</a>
                    <a href="#how-it-works" onClick={() => setIsMenuOpen(false)} className="block px-4 py-3 text-base font-semibold text-slate-700 hover:bg-panhari-red/5 hover:text-panhari-red rounded-xl transition-colors">How it works</a>
                    <a href="#stories" onClick={() => setIsMenuOpen(false)} className="block px-4 py-3 text-base font-semibold text-slate-700 hover:bg-panhari-red/5 hover:text-panhari-red rounded-xl transition-colors">Stories</a>
                    <button className="w-full mt-4 bg-gradient-to-r from-panhari-red to-panhari-orange text-white px-5 py-3.5 rounded-xl text-base font-semibold shadow-lg shadow-panhari-red/20 active:scale-95 transition-all">
                        Book a Demo
                    </button>
                </div>
            </nav>
            ...
            <section className="pt-32 pb-20 md:pt-48 md:pb-32 px-4 relative overflow-hidden">
                <div className="absolute top-20 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-panhari-red/10 rounded-full blur-[120px] -z-10 animate-pulse-soft" style={{ animationDuration: '4s' }}></div>
                <div className="absolute top-40 right-0 w-[400px] h-[400px] bg-panhari-orange/10 rounded-full blur-[100px] -z-10 animate-pulse-soft" style={{ animationDuration: '5s' }}></div>

                <div className="max-w-7xl mx-auto text-center relative z-10">
                    <div className="animate-fade-up inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/60 backdrop-blur-md border border-panhari-red/20 shadow-sm text-panhari-red text-sm font-semibold mb-8 hover:shadow-md transition-shadow cursor-pointer hover:border-panhari-red/30 group">
                        <span className="relative flex h-2 w-2">
                            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-panhari-red/75 opacity-75"></span>
                            <span className="relative inline-flex rounded-full h-2 w-2 bg-panhari-red"></span>
                        </span>
                        Every application is someone's next chapter
                        <ChevronRight className="w-4 h-4 text-panhari-red/70 group-hover:translate-x-1 transition-transform" />
                    </div>
                    ...
                    <h1 className="animate-fade-up delay-100 text-5xl md:text-7xl lg:text-[5.5rem] font-black tracking-tight text-slate-900 mb-8 max-w-5xl mx-auto leading-[1.05]">
                        ...
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-panhari-red via-panhari-orange to-panhari-red relative inline-block px-2">
                            every application.
                            <svg className="absolute w-full h-4 -bottom-2 left-0 text-panhari-orange/40 -z-10" viewBox="0 0 100 10" preserveAspectRatio="none">
                    ...
                    <div className="animate-fade-up delay-300 flex flex-col sm:flex-row items-center justify-center gap-4">
                        <button className="w-full sm:w-auto px-8 py-4 bg-panhari-dark hover:bg-panhari-red text-white rounded-full text-lg font-bold transition-all duration-300 shadow-xl shadow-slate-200 hover:shadow-panhari-red/30 flex items-center justify-center gap-2 group transform hover:-translate-y-1">
                            Watch a Demo
                ...
                <ContainerScroll
                    titleComponent={
                        <>
                            <p className="text-sm font-bold tracking-widest text-panhari-orange uppercase mb-4">Built around people, not paperwork</p>
            ...
            <section className="py-14 border-y border-slate-200/40 relative z-20 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 text-center">
                    ...
                    <div className="flex flex-wrap justify-center items-center gap-12 md:gap-24 opacity-40 grayscale hover:grayscale-0 transition-all duration-700">
                        <div className="text-2xl font-black font-serif hover:text-panhari-red transition-colors duration-300 transform hover:scale-105">Acme</div>
                        <div className="text-xl font-black tracking-tight hover:text-panhari-red transition-colors duration-300 transform hover:scale-105">GLOBAL <span className="font-light">CO</span></div>
                        <div className="text-3xl font-bold italic font-serif hover:text-panhari-red transition-colors duration-300 transform hover:scale-105">Nexus</div>
                        <div className="text-xl font-bold tracking-widest hover:text-panhari-red transition-colors duration-300 transform hover:scale-105">ELEVATE</div>
                        <div className="text-xl font-extrabold hidden sm:block hover:text-panhari-red transition-colors duration-300 transform hover:scale-105">Founders</div>
                    </div>
                </div>
            </section>
            ...
            <section id="features" className="py-24 md:py-32 px-4 max-w-7xl mx-auto relative">
                ...
                <div className="grid md:grid-cols-3 gap-8 md:gap-10">
                    {[
                        {
                            icon: <img src={iconUbuntu} alt="Ubuntu Icon" className="w-10 h-10 object-contain drop-shadow-sm" />,
                        ...
                        {
                            icon: <img src={iconYouthLed} alt="Youth-Led Icon" className="w-10 h-10 object-contain drop-shadow-sm" />,
                            ...
                            color: "panhari-orange"
                        },
                        {
                            icon: <img src={iconScalable} alt="Scalable Icon" className="w-10 h-10 object-contain drop-shadow-sm" />,
                        ...
                        <div key={i} className={`animate-fade-up delay-${(i + 1) * 100} group bg-white p-8 md:p-10 rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-2xl hover:shadow-${feature.color}/20 transition-all duration-500 hover:-translate-y-2 relative overflow-hidden backdrop-blur-sm`}>
                            <div className={`absolute -top-10 -right-10 w-40 h-40 bg-${feature.color}/10 rounded-full blur-2xl -z-10 transition-transform duration-500 group-hover:scale-150`}></div>
                            <div className={`w-16 h-16 bg-${feature.color}/10 text-${feature.color} rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 group-hover:rotate-6 transition-transform duration-300 shadow-sm border border-${feature.color}/20`}>
                                {feature.icon}
                            </div>
                ...
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-16 md:gap-24 mb-32 group">
                        <div className="flex-1 space-y-8 animate-fade-up">
                            <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-panhari-red/10 text-panhari-red text-sm font-bold border border-panhari-red/20 shadow-sm">
                            ...
                            <ul className="space-y-4 pt-4">
                                {['Drag-and-drop form builder', 'Auto-save progress for candidates', 'Holistic Selection Governance System'].map((item, i) => (
                                    <li key={i} className="flex items-center gap-4 text-slate-700 text-lg font-medium group-hover:translate-x-3 transition-transform duration-500" style={{ transitionDelay: `${i * 100}ms` }}>
                                        <div className="w-7 h-7 rounded-full bg-panhari-red/10 flex items-center justify-center flex-shrink-0 shadow-sm border border-panhari-red/20">
                                            <CheckCircle2 className="w-4 h-4 text-panhari-red" />
                                        </div>
                                        <span>{item}</span>
                                    </li>
                                ))}
                        ...
                        <div className="flex-1 w-full relative group perspective-1000">
                            <div className="absolute inset-0 bg-gradient-to-tr from-panhari-red/20 to-panhari-orange/20 rounded-[3rem] transform rotate-3 scale-105 group-hover:rotate-6 group-hover:scale-110 transition-all duration-700 blur-sm"></div>
                            ...
                            <div className="absolute -bottom-6 -left-6 bg-white p-4 rounded-2xl shadow-xl border border-slate-100 z-20 animate-float flex items-center gap-4 group-hover:scale-105 transition-transform">
                                <div className="w-12 h-12 bg-panhari-red/10 text-panhari-red rounded-full flex items-center justify-center">
                    ...
                    <div className="flex flex-col md:flex-row-reverse items-center gap-16 md:gap-24 mb-32 group">
                        <div className="flex-1 space-y-8 animate-fade-up">
                            <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-panhari-orange/10 text-panhari-orange text-sm font-bold border border-panhari-orange/20 shadow-sm">
                            ...
                            <ul className="space-y-4 pt-4">
                                {['Customizable pipeline stages', 'Trigger-based email templates', 'Cohort Oversight Processing'].map((item, i) => (
                                    <li key={i} className="flex items-center gap-4 text-slate-700 text-lg font-medium group-hover:-translate-x-3 transition-transform duration-500" style={{ transitionDelay: `${i * 100}ms` }}>
                                        <div className="w-7 h-7 rounded-full bg-panhari-orange/10 flex items-center justify-center flex-shrink-0 shadow-sm border border-panhari-orange/20">
                                            <CheckCircle2 className="w-4 h-4 text-panhari-orange" />
                                        </div>
                                        <span>{item}</span>
                                    </li>
                                ))}
                        ...
                        <div className="flex-1 w-full relative group perspective-1000">
                            <div className="absolute inset-0 bg-gradient-to-tr from-panhari-orange/20 to-panhari-red/10 rounded-[3rem] transform -rotate-3 scale-105 group-hover:-rotate-6 group-hover:scale-110 transition-all duration-700 blur-sm"></div>
                            ...
                            <div className="absolute -top-6 -right-6 bg-white p-4 rounded-2xl shadow-xl border border-slate-100 z-20 animate-float-delayed flex items-center gap-4 group-hover:scale-105 transition-transform">
                                <div className="w-12 h-12 bg-panhari-orange/10 text-panhari-orange rounded-full flex items-center justify-center">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-16 md:gap-24 mb-32 group">
                        <div className="flex-1 space-y-8 animate-fade-up">
                            <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-panhari-dark/5 text-panhari-dark text-sm font-bold border border-panhari-dark/10 shadow-sm">
                            ...
                            <ul className="space-y-4 pt-4">
                                {['Sentiment & feedback analysis', 'Real-time performance metrics', 'Custom dynamic reporting'].map((item, i) => (
                                    <li key={i} className="flex items-center gap-4 text-slate-700 text-lg font-medium group-hover:translate-x-3 transition-transform duration-500" style={{ transitionDelay: `${i * 100}ms` }}>
                                        <div className="w-7 h-7 rounded-full bg-panhari-dark/5 flex items-center justify-center flex-shrink-0 shadow-sm border border-panhari-dark/10">
                                            <CheckCircle2 className="w-4 h-4 text-panhari-dark" />
                                        </div>
                                        <span>{item}</span>
                                    </li>
                                ))}
                        ...
                        <div className="flex-1 w-full relative group perspective-1000">
                            <div className="absolute inset-0 bg-gradient-to-tr from-panhari-dark/10 to-transparent rounded-[3rem] transform rotate-3 scale-105 group-hover:rotate-6 group-hover:scale-110 transition-all duration-700 blur-sm"></div>
                    ...
                    <div className="flex flex-col md:flex-row-reverse items-center gap-16 md:gap-24 mb-32 group">
                        ...
                        <div className="flex-1 w-full relative group perspective-1000">
                            <div className="absolute inset-0 bg-gradient-to-tr from-panhari-red/20 to-panhari-orange/10 rounded-[3rem] transform -rotate-3 scale-105 group-hover:-rotate-6 group-hover:scale-110 transition-all duration-700 blur-sm"></div>
                            <img src={imgChatbot}
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-16 md:gap-24 group">
                        ...
                        <div className="flex-1 w-full relative group perspective-1000">
                            <div className="absolute inset-0 bg-gradient-to-tr from-slate-200/50 to-transparent rounded-[3rem] transform rotate-3 scale-105 group-hover:rotate-6 group-hover:scale-110 transition-all duration-700 blur-sm"></div>
                            <img src={imgRbac}
            ...
            {/* Testimonial */}
            <section className="py-32 bg-panhari-dark text-white relative overflow-hidden" id="stories">
                <div className="absolute top-0 left-0 w-full h-full opacity-30 pointer-events-none">
                    <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-gradient-to-bl from-panhari-red/40 to-transparent rounded-full blur-[80px] transform translate-x-1/3 -translate-y-1/3"></div>
                    <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-gradient-to-tr from-panhari-orange/30 to-transparent rounded-full blur-[80px] transform -translate-x-1/3 translate-y-1/3"></div>
                </div>
                ...
                <div className="max-w-5xl mx-auto px-4 text-center relative z-10 animate-fade-up">
                    <div className="mb-10 flex justify-center gap-1.5 hover:scale-105 transition-transform duration-300">
                        {[1, 2, 3, 4, 5].map((star, i) => (
                            <svg key={star} className={`w-8 h-8 text-panhari-orange fill-current drop-shadow-xl animate-fade-up delay-${i * 100}`} viewBox="0 0 24 24">
                    ...
                    <div className="flex items-center justify-center gap-5">
                        <div className="w-16 h-16 bg-gradient-to-br from-panhari-red to-panhari-orange rounded-full flex items-center justify-center text-xl font-black shadow-xl shadow-panhari-red/20 border-2 border-white/20 hover:scale-110 transition-transform cursor-pointer">
                            SJ
                        </div>
                        <div className="text-left">
                            <div className="font-bold text-xl text-white tracking-wide">Sarah Jenkins</div>
                            <div className="text-panhari-orange/90 font-semibold">Program Director, Global Innovators</div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 px-4 bg-[#FAFAFA] relative">
                <div className="max-w-6xl mx-auto glass-panel border border-slate-200/60 bg-white/60 rounded-[3rem] p-10 md:p-24 text-center shadow-2xl relative overflow-hidden group">
                    <div className="absolute inset-0 bg-panhari-dark z-0 opacity-100 transition-opacity duration-1000"></div>

                    <div className="absolute top-0 right-0 -mt-20 -mr-20 w-96 h-96 bg-panhari-red/40 rounded-full blur-[80px] group-hover:scale-125 group-hover:translate-x-10 transition-all duration-1000 ease-in-out z-0"></div>
                    <div className="absolute bottom-0 left-0 -mb-20 -ml-20 w-96 h-96 bg-panhari-orange/30 rounded-full blur-[80px] group-hover:scale-125 group-hover:-translate-x-10 transition-all duration-1000 ease-in-out z-0"></div>
                    ...
                    <div className="relative z-10 text-white">
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-6">
                            <button className="px-10 py-5 bg-white text-panhari-dark hover:text-panhari-red hover:bg-slate-50 rounded-full text-lg font-black transition-all duration-300 shadow-xl shadow-panhari-red/20 hover:shadow-panhari-red/40 transform hover:-translate-y-1 hover:scale-105 active:scale-95">
                                Watch a Demo
                            </button>
                        ...
                        <p className="mt-8 text-sm text-white/70 font-bold uppercase tracking-widest">No credit card required • 14-day free trial</p>
                    </div>
                </div>
            </section>
